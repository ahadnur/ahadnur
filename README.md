...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Consolas+&color=F7B847&center=true&vCenter=true&multiline=true&width=800&height=60&lines=Programming+tutor+and+Frontend+Developer+specilized+in+HTML+CSS+JavaScript+Python.+;My+favourite+hobby+is+to+script+open+source+bots.)](https://git.io/typing-svg)
